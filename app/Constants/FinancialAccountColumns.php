...
class FinancialAccountColumns
{
    ...
    public const STOCK_SYMBOL   = 'stock_symbol'; // Stock symbol for equity assets
    public const CURRENT_PRICE  = 'current_price'; // Current market price
    public const PRICE_UPDATED_AT = 'price_updated_at'; // Last price update timestamp
